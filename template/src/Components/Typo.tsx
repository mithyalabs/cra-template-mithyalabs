...
const Typo: React.FC<TypoProps> = (props) => {
    const { children, weight = 'regular', whiteSpace, underline = false, contrast = false, ...typographyProps } = props;
    const theme = useTheme()
    const style = { ...typographyProps.style, textDecoration: underline ? 'underline' : undefined, fontWeight: getFontWeight(theme, weight), whiteSpace, color: contrast ? 'white' : undefined }
